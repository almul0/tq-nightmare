...
set(HEADER_POCO_1 ${POCO_DIRECTORY}/Crypto/include)
set(HEADER_POCO_5 ${POCO_DIRECTORY}/Foundation/include)
set(HEADER_POCO_6 ${POCO_DIRECTORY}/Net/include)
set(HEADER_POCO_7 ${POCO_DIRECTORY}/NetSSL_OpenSSL/include)
set(HEADER_POCO_8 ${POCO_DIRECTORY}/Util/include)
set(HEADER_POCO_9 ${POCO_DIRECTORY}/XML/include)
set(HEADER_POCO_11 ${POCO_DIRECTORY}/JSON/include)
...
set(HEADER_UTF8 ${OF_DIRECTORY}/libs/utf8/include)
set(HEADER_JSON ${OF_DIRECTORY}/libs/json/include)

set(OF_CORE_HEADERS ${HEADER_OF_0} ${HEADER_OF_1} ${HEADER_OF_2} ${HEADER_OF_3} ${HEADER_OF_4} ${HEADER_OF_5} ${HEADER_OF_6} ${HEADER_OF_7} ${HEADER_OF_8} ${HEADER_OF_9} ${HEADER_OF_10} ${HEADER_OF_11} ${HEADER_POCO_7} ${HEADER_POCO_6} ${HEADER_POCO_1} ${HEADER_POCO_8} ${HEADER_POCO_9} ${HEADER_POCO_11} ${HEADER_POCO_5} ${HEADER_KISS} x${HEADER_FREETYPE} ${HEADER_FREETYPE2} ${HEADER_FMODEX} ${HEADER_FREEIMAGE} ${HEADER_TESS2} ${HEADER_GLFW} ${HEADER_UTF8} ${HEADER_JSON})
# ========================================================

# ===================== Libs =====================
#set(LIB_GLFW ${OF_DIRECTORY}/libs/glfw/lib/linux64/libglfw3.a)
set(LIB_KISS ${OF_DIRECTORY}/libs/kiss/lib/linux64/libkiss.a)
#set(LIB_POCO_1 ${POCO_DIRECTORY}/libs/poco/lib/Linux/x86_64/libPocoCrypto.a)
#set(LIB_POCO_5 ${POCO_DIRECTORY}/libs/poco/lib/Linux/x86_64/libPocoFoundation.a)
#set(LIB_POCO_6 ${POCO_DIRECTORY}/libs/poco/lib/Linux/x86_64/libPocoNet.a)
#set(LIB_POCO_7 ${POCO_DIRECTORY}/libs/poco/lib/Linux/x86_64/libPocoNetSSL.a)
#set(LIB_POCO_8 ${POCO_DIRECTORY}/libs/poco/lib/Linux/x86_64/libPocoUtil.a)
#set(LIB_POCO_9 ${POCO_DIRECTORY}/libs/poco/lib/Linux/x86_64/libPocoXML.a)
#set(LIB_POCO_11 ${POCO_DIRECTORY}/libs/poco/lib/Linux/x86_64/libPocoJSON.a)
...
set(PLATFORM_STATIC_LIBS ${LIB_KISS} ${LIB_TESS})
